...
public class TestRender extends Render {
	...
	public TestRender(RenderManager p_i46184_1_) {
		super(p_i46184_1_);
	 ...
	 */
	public void doRender(TestEntity entity, double x, double y, double z, float p_76986_8_, float partialTicks) {
	...
	protected ResourceLocation getEnderCrystalTextures(TestEntity p_180554_1_) {
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return this.getEnderCrystalTextures((TestEntity) entity);
	}
	...
	public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float partialTicks) {
		this.doRender((TestEntity) entity, x, y, z, p_76986_8_, partialTicks);
	}
}